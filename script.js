...
const presentationStructure = [
    ...
    { path: 'module2', slides: 8, name: 'Modulo 2: Principios Centrales de Lean' },
    // Example for Module 3 - REPLACE WITH YOUR ACTUAL DATA
    { path: 'module3', slides: 8,  name: 'Modulo 3: Principios Centrales de Six Sigma' },

    // !!! ADD ALL YOUR MODULES HERE FOLLOWING THE SAME FORMAT !!!
    // For instance, if you have 10 modules:
    { path: 'module4', slides: 10, name: 'Modulo 4: La Fase Definir - Estableciendo los Cimientos' },
    { path: 'module5', slides: 8, name: 'Modulo 5: Introducción al Mapeo de Procesos' },
    { path: 'module6', slides: 8,  name: 'Modulo 6: La Fase Medir' },
    { path: 'module7', slides: 9,  name: 'Module 7: La Fase de Análisis' },
    { path: 'module8', slides: 8, name: 'Module 8: Introducción a las Herramientas Lean' },
    { path: 'module9', slides: 8,  name: 'Module 9: Las Fases de Mejora y Control' },
    { path: 'module10', slides: 8, name: 'Modulo 10: Ideas de Proyecto, Revisión y Próximos Pasos' }
];
